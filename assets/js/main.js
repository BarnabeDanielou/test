...
/*==================== LANGUAGE BUTTON ====================*/
function swapLinks(event) {
    event.preventDefault();
    var links = document.getElementsByTagName("a");
    for (var i = 0; i < links.length; i++) {
      var href = links[i].getAttribute("href");
      if (href == "../fr/index-fr.html") {
        links[i].setAttribute("href", "../en/index-en.html");
        document.getElementById("language-flag-img").setAttribute("alt", "Français");
        document.getElementById("language-flag-img").setAttribute("src", "../assets/favicon_io/france.svg");
      } else if (href == "../en/index-en.html") {
        links[i].setAttribute("href", "../fr/index-fr.html");
        document.getElementById("language-flag-img").setAttribute("alt", "English");
        document.getElementById("language-flag-img").setAttribute("src", "../assets/favicon_io/gb.svg");
      }
    }
  }
...
function SendMail() {
    ...
    emailjs.send('service_igg2oln', 'template_vp1ku4x', templateParams)
